...
//외부 클래스 : 객체를 생성하기 위한 설계도, 템플릿 (틀)
 class A {
	...
	A() {
		//기본 생성자 : 인풋 메개 변수가 비어있는 생성자를 기본 생성자.
	}
	
	//메소드 : 함수, 호출시 작동됨
	// 리턴타입 메소드명(인풋메개변수) { 메소드 호출시 프로그램 실행 코드 }
...
class C {
	int age = 21;
	String birthday = "2002-09-14";
	String name = "yeongsik";
	C() {
...
public class Object02 {
	...
	public static void main(String[] args) {
		...
		//자료형
		//클래스명 참조변수 = new A();
		// A : 클래스, 객체 자료형, 동일한 패키지 안에 클래스가 존재할때 improt 없이 사용 가능
		...
		//A 클래스를 기준으로 2번째 객체 생성
			...
			//3. aa객체의 메소드 호출
			aa.print();
			System.out.println("============C 클래스 기준으로 객체 생성========================");

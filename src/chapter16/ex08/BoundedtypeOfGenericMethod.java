...
class A {
	//Number : Boolean, Character 를 제외한 정수, 실수를 처리하는
		//Byte, Short, Integer, Long, Float, Double
	
	public <T extends Number> void method1 (T t) {
		//Object 클래스의 메소드외의 Number의 메소드를 사용 가능함.
...
class B {
	...
	//T : MyInterface 하위의 구현클래스가 올 수 있다. , 주의 : 타입을 제한할 때는 extends 를 사용
...
//		a.<String> method1("안녕"); // 넘버타입이 아닌 다른 타입은 올 수 없다.

...
class MethodOverloading {
	...
	//메소드 오버로딩 : 동일한 이름의 메소드이지만 시그니처에 따라서 다른 메소드를 호출하는 것
		// 시그니처 : 메개변수 갯수, 메개변수의 데이터 타입 <==
	void print() {	//print () : 인풋 메개변수가 없는 메소드
		System.out.println("데이터가 없습니다. ");
	}
	void print (int a) {	//print(int a) : 인풋 메개변수에 정수 1개를 인풋받는 메소드
...
public class Method_Overloading {
	...
	public static void main(String[] args) {
		...
		// 	 - 시그니쳐 : 메소드의 인풋 메개변수 갯수, 인풋 되는 타입이 다를 경우 다른 메소드로 식별
		// 메소드 오버라이딩 : 상속에서만 적용됨

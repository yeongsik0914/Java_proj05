...
class Student {
	...
	//getter (필드의 값을 리턴으로 돌려줌), setter (인풋 값을 받아서 필드에 적용) 생성
	...
	public void setMonth(int month) {
		if (month >= 1 && month <= 12) {
			...
			System.out.println("잘못된 입력 값입니다. 1~12 사이의 정수 값을 넣으세요.");
		}
		
	}

	//toString() 재정의 : 객체의 Heap 메모리의 주소값 출력, hashcode로 출력 (16진수로)
	//객체 자체를 출력했을 때 toStrbg() 가 작동.
	@Override
...
public class Initial_Field01 {
	...
	public static void main(String[] args) {
		...
		s1.stuAdd = "서울 종로구";
		s1.stuID = 1111;
		s1.stuPhone = "010-1234-5678";
		s1.weight = 80.5;
		
		
		System.out.println(s1);				// 객체를 출력할 때 toString() 메소드가 출력됨.
		System.out.println(s1.toString());
		System.out.println("====================================");
		//2. 객체를 생성 시 생성자를 통해서 필드의 값을 할당.
	/*	Student s2 = new Student("이순신", 2222, 30, "서울 강남구", "010-2222-2222", 85.5);
		...
		//3. Setter를 사용해서 값을 넣고 getter를 통 사용해서 필드의 값을 출력

...
public class TypeCasting01 {
	...
	public static void main(String[] args) {
		...
		Animal a1 = (Animal)new Tiger();	//Tiger 객체를 생성해서 Animal 타입으로 지정
		...
		//2. 다운 캐스팅 : Animal (부모 타입) --> Tiger (자식 타입), 수동으로 명시
			//al : Tiger 필드, 메소드 + Animal 필드와 메소드도 포함.
		...
		//다운 캐스팅 : 실행 시 오류 발생, t3에는 TigerChild는 내포하고 있지 않기 때문에 다운캐스팅 실행시 오류 발생
		...
		//다운 캐스팅할 때는 반드시 instanceof를 사용해야 한다. 

...
class Aa {	//equals()가 정의되어 있지 않은 클래스
			//Object 클래스의 equals() 메소드는 stack의 잠소 주소를 비교하도록 설정
	//필드 1
	String name;
...
class Bb {	//Object의 equals()를 재정의 하여 Heap의 값을 비교하도록 설정
	//필드 1
	String name;
...
public class Object_Method2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(s1.equals(s2));	//Heap의 값을 비교, true
			//String 클래스는 Object의 equals() 재정의 되어 있다.
		
		System.out.println("==================");
		Aa a1 = new Aa("안녕");
		Aa a2 = new Aa("안녕");
		System.out.println(a1 == a2);		//Stack의 참조주소를 비교, false
		System.out.println(a1.equals(a2));	//Stack의 참조주소를 비교, false
		
		System.out.println("==================");
		Bb b1 = new Bb("안녕");
		Bb b2 = new Bb("안녕");
		System.out.println(b1 == b2); 		//Stack의 참조주소를 비교, false
			//equals() 메소드를 재정의 해서

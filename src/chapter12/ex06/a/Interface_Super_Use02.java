...
interface A {	//인터페이스 : 추상 메소드만 존재해야 함 ( 예외 : default, static 메소드)
	default void abc1() {
...
//class D sms  c  클래스를 상속하고 있고 A, B 인터페이스를 구현하고 있다.
	//extends : 하나의 부모만 올 수 있다.	: 클래스 : 하나의 부모만 가능 (다중 상속이 불가능)

...
public class Array_Input_Output {
	...
	public static void main(String[] args) {
		...
		// arr2 에 방을 100개 선언, For문을 사용해서 각 방에 1부터 시작해서 1씩 증가 
		int[] arr2 = new int[100];
		
		// for 문을 사용해서 값 할당 하기 : i는 index (방 번호)
		...
		// Enhanced For : 배열의 각 방의 값을 출력 할때 쉽게 출력할 수 있다.
		// 		- 0 ~ 마지막 방까지 한꺼번에 출력 
		...
		// Array.toString(arr3) : 배열 변수에 저장된 모든 값들을 출력
			// Arrays : 객체
			// toString () : 메소드(함수)
		...
		System.out.println("========배열의 방의 갯수를 출력 =========");
		
		System.out.println(arr1.length); // 방 갯수 : 5개
		System.out.println(arr2.length); // 방 갯수 : 100개
		System.out.println(arr3.length); // 방 갯수 : 100개

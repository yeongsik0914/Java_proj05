...
public class String_Method {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1.indexOf('a'));	//문자 a 가 저장된 방 번호를 출력 : 7  방향 : ->
		System.out.println(str1.lastIndexOf('a'));	//문자 a 가 저장된 방 번호를 출력 : 9  방향 : <-
		
		System.out.println(str1.indexOf('a', 8)); // 8번방부터 a를 검색 : 9 방향 : ->
		System.out.println(str1.lastIndexOf('a', 8)); // 8번방부터 a를 검색 : 7 방향 : <-
		...
		// String.valueOf() : 기본자로형을 ==> String 자료형으로 변환
		
	//	String str3 = 2.3; //오류발생 : 2.3 (double 형 데이터를 String에 저장시 오류)
	...
	//  String str4 = true;			//boolean 타입을 String 변수에 저장시 오류 발생
		...
		String str8 = "안녕".concat(String.valueOf(3));	//내부적으로 작동됨0 
		...
		System.out.println(str13.substring(3,5));	//자반
		
		//split() : 특정 문자를 기준으로 잘라서 문자열 배열에 저장
		String[] strArray = "abc/def-ght jkl".split("/|-| ");
		...
		//6. 문자열의 내용비교 ( equals(), equalsIgnoreCase() )
			...
			//equals() : Heap 의 값을 비교 , 대소문자까지 확인
			//equalsIgnoreCase() : Heap 의 값을 비교, 대소문자를 확인하지 않고 비교

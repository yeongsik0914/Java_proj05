...
public class Ex02 {
	...
	public static void main(String[] args) {
		...
		//3. 배열의 각 방에 저장된 내용을 출력 : for, Enhaced for, Arrays.toString(arr1)
		System.out.println("=== for 문을 사용해서 배열의 각 방의 내용을 출력 ===");
		for ( int i=0; i<arr1.length; i++) {
			System.out.print( arr1[i] + " ");
		}
		
		System.out.println("\n=== Enhanced for 문을 사용해서 배열의 각 방의 내용을 출력 ===");
		// 0번 방부터 마지막 방까지 순환하면서 출력, for 문 보다는 구문이 짧다.
		for (int d : arr1) {
			System.out.print(d+" ");
		}
		
		System.out.println("\n=== Arrays.toString(arr1) 을 사용해서 배열의 각 방의 내용을 출력 ===");

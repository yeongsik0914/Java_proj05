...
class C {
	int a = 10;					//인스턴스 필드 : 객체화 해서 사용가능, 다른 객체와는 공유되지 않는 값
									//메모리의 Heap 공간에 변수와 값을 저장
	static int b = 20;			//정적 필드 : 객체화 하지 앙ㄶ고 사용 가능,
										//모든 객체에서 공유되는 변수
	...
	static void print2 () {		//정적 메소드에는 인스턴스 필드가 올 수 없다.
...
public class Instance_VS_Static02 {
	...
	public static void main(String[] args) {
		...
		c3.a = 777;
		c1.b = 333;		// 모든 객체에서 공유되는 블락
		System.out.println("======================");
		System.out.println(c1.a);	//인스턴스 필드 : 다른 객체와 분리된 고유 번호

...
public class Operation_DataType {
	...
	public static void main(String[] args) {
		...
		double data4 = 8/5.0;		// 정수 8이 double 형으로 업캐스팅 되어서 연산
		...
		// 2. 다른 자료형 간의 연산 (작은 자료형은 높은 자료형으로 업 캐스팅이 자동으로 일어나고 연산)
		...
		double data9 = 5/2.0; // 정수 5가 double 로 업 캐스팅
		...
		// 업캐스팅 : data12 (int) -> data12(int)
		System.out.println(data11 / (int) data12);
		
		// <문제>
		// 국어 : 90, 수학 : 88, 영어 : 77, 음악 : 90, 과학 : 99
		// 각 과목의 점수를 int 의 변수를 만들어서 저장 후 : 합계(sum), 평균(avg) 값을 출력.
		...
		sum = (kor + math + eng + muc + sci);
		avg = (sum/5.0);
		
		System.out.println("과목의 합계는 : " + sum);
		System.out.println("과목의 평균은 : " + avg);
		System.out.println("===================="); 
